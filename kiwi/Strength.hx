...
class Strength {
	 ...
	 */
	public static var required(default, never) = create(1000.0, 1000.0, 1000.0);
	public static var strong(default, never) = create(1.0, 0.0, 0.0);
	public static var medium(default, never) = create(0.0, 1.0, 0.0);
	public static var weak(default, never) = create(0.0, 0.0, 1.0);
